...
def create_footer() -> Panel:
    ...
    return Panel(
        "Made with [bold magenta]:heart:[/bold magenta]  by MeherMankar",
    ...
    try:
        ...
        while not login_successful:
            try:
                ...
                elif udemy.settings.get("access_token"):
                    login_method = "Saved Session"
                else:
                    email = console.input("[cyan]Email: [/cyan]")
                    password = console.input("[cyan]Password (will not be saved): [/cyan]", password=True)
                ...
                elif "Saved Session" in login_method:
                    udemy.settings["access_token"] = ""
                    udemy.settings["client_id"] = ""
                    udemy.settings["csrf_token"] = ""
